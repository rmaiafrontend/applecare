...
const paymentIcons = { pix: QrCode, credit_card: CreditCard, debit_card: CreditCard, boleto: FileText };
const paymentLabels = { pix: 'PIX', credit_card: 'Cartao de Credito', debit_card: 'Cartao de Debito', boleto: 'Boleto Bancario' };
