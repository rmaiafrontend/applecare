  ...
  return (
    <div className="space-y-4">
      ...
      <FieldRow label="Texto do CTA">
        <Input value={form.ai_button_cta_text || ""} onChange={e => updateField("ai_button_cta_text", e.target.value)} placeholder="Pergunte à IA" className="h-10 rounded-xl text-[13px] border-black/[0.06] dark:border-white/[0.06] bg-[#fafafa] dark:bg-[#1c1c1e] dark:text-[#f5f5f7] focus:bg-white dark:focus:bg-[#2c2c2e]" />
      ...
      <div className="grid grid-cols-2 gap-3">
        <FieldRow label="Gradiente início">
          <div className="flex items-center gap-2 bg-[#fafafa] dark:bg-[#1c1c1e] border border-black/[0.06] dark:border-white/[0.06] rounded-xl px-3 py-2">
            ...
            <input type="text" value={form.ai_button_gradient_from || "#6366f1"} onChange={e => updateField("ai_button_gradient_from", e.target.value)} className="flex-1 bg-transparent text-[12px] font-mono text-[#1d1d1f] dark:text-[#f5f5f7] outline-none uppercase" maxLength={7} />
          </div>
        </FieldRow>
        <FieldRow label="Gradiente fim">
          <div className="flex items-center gap-2 bg-[#fafafa] dark:bg-[#1c1c1e] border border-black/[0.06] dark:border-white/[0.06] rounded-xl px-3 py-2">
            ...
            <input type="text" value={form.ai_button_gradient_to || "#a855f7"} onChange={e => updateField("ai_button_gradient_to", e.target.value)} className="flex-1 bg-transparent text-[12px] font-mono text-[#1d1d1f] dark:text-[#f5f5f7] outline-none uppercase" maxLength={7} />
          </div>
        </FieldRow>
      </div>
