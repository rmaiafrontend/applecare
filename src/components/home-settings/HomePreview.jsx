...
export default function HomePreview({ form }) {
  // Scale factor: iframe renders at 390px width, frame inner width is ~274px
  const iframeWidth = 390;
  const iframeHeight = 844;
  const frameInnerWidth = 274;
  ...
  return (
    <div className="sticky top-20">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-[9px] font-medium text-black/20 bg-black/[0.03] px-2 py-0.5 rounded-full">Catálogo real</span>
      </div>
