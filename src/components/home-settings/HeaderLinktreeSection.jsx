...
import { Plus, X, Settings, ExternalLink } from "lucide-react";
...
export default function HeaderLinktreeSection({ form, updateField }) {
  ...
  return (
    <div className="space-y-6">
      {/* Info: campos gerenciados em Configurações */}
      <div className="flex items-start gap-3 bg-[#007aff]/[0.06] dark:bg-[#0a84ff]/[0.08] border border-[#007aff]/10 dark:border-[#0a84ff]/15 rounded-xl p-3.5">
        <Settings className="w-4 h-4 text-[#007aff] dark:text-[#0a84ff] mt-0.5 shrink-0" strokeWidth={2} />
        <div className="flex-1 min-w-0">
          <p className="text-[12px] font-semibold text-[#1d1d1f] dark:text-[#f5f5f7] leading-snug">
            Nome, logo, WhatsApp e Instagram
          </p>
          <p className="text-[11px] text-[#86868b] dark:text-[#98989d] mt-0.5 leading-snug">
            Esses campos são gerenciados em Configurações da Loja para manter consistência em todo o catálogo.
          </p>
          <a
            href="?view=store-settings"
            className="inline-flex items-center gap-1 mt-2 text-[11px] font-semibold text-[#007aff] dark:text-[#0a84ff] hover:underline"
          >
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <p className="text-[12px] font-bold text-[#1d1d1f] dark:text-[#f5f5f7]">1.2 Links Rápidos</p>
      ...
      {/* 1.3 Redes Sociais (extras) */}
      <div className="space-y-3">
        <p className="text-[12px] font-bold text-[#1d1d1f] dark:text-[#f5f5f7]">1.3 Redes Sociais</p>
        <p className="text-[10px] text-[#86868b] dark:text-[#98989d] -mt-1">Redes adicionais exibidas no header (WhatsApp e Instagram ficam em Configurações)</p>
