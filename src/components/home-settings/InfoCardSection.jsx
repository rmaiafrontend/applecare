    ...
    <div className="space-y-4">
      <div className="grid grid-cols-3 gap-3">
        <FieldRow label="Emoji/Ícone">
          <Input value={form.info_card_emoji || ""} onChange={e => updateField("info_card_emoji", e.target.value)} placeholder="🚚" className="h-10 rounded-xl text-[16px] text-center border-black/[0.06] bg-[#fafafa] focus:bg-white" maxLength={2} />
        </FieldRow>
        <div className="col-span-2">
          <FieldRow label="Título" required>
            <Input value={form.info_card_title || ""} onChange={e => updateField("info_card_title", e.target.value)} placeholder="Frete grátis para SP" className="h-10 rounded-xl text-[13px] border-black/[0.06] bg-[#fafafa] focus:bg-white" />
      ...
      <FieldRow label="Descrição">
        <Textarea value={form.info_card_description || ""} onChange={e => updateField("info_card_description", e.target.value)} placeholder="Texto descritivo do card..." className="rounded-xl text-[13px] min-h-[70px] border-black/[0.06] bg-[#fafafa] focus:bg-white" />
      </FieldRow>

      <div className="grid grid-cols-2 gap-3">
        <FieldRow label="Texto do CTA">
          <Input value={form.info_card_cta_text || ""} onChange={e => updateField("info_card_cta_text", e.target.value)} placeholder="Saiba mais" className="h-10 rounded-xl text-[13px] border-black/[0.06] bg-[#fafafa] focus:bg-white" />
        ...
        <FieldRow label="Link do CTA">
          <Input value={form.info_card_cta_link || ""} onChange={e => updateField("info_card_cta_link", e.target.value)} placeholder="/frete ou URL" className="h-10 rounded-xl text-[13px] border-black/[0.06] bg-[#fafafa] focus:bg-white" />
        </FieldRow>
      </div>
      ...
      <FieldRow label="Cor de fundo">
        <div className="flex items-center gap-2 bg-[#fafafa] border border-black/[0.06] rounded-xl px-3 py-2">
          ...
          <input type="text" value={form.info_card_bg_color || "#f5f5f7"} onChange={e => updateField("info_card_bg_color", e.target.value)} className="flex-1 bg-transparent text-[12px] font-mono text-[#1d1d1f] outline-none uppercase" maxLength={7} />
        </div>
      </FieldRow>
