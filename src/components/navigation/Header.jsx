...
export default function Header({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 safe-area-top">
      <div className="bg-white/80 backdrop-blur-xl border-b border-gray-100/60">
          ...
          <div className="flex items-center gap-0.5">
            ...
            {showShare && (
              <button
                ...
                className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-black/5 active:scale-95 transition-all"
              >
                <Share2 className="w-[17px] h-[17px] text-gray-700" strokeWidth={2} />
              </button>
            )}
            ...
            {showCart && (
              ...
              >
                <ShoppingCart className="w-[18px] h-[18px] text-gray-700" strokeWidth={2} />
                {cartCount > 0 && (
