          ...
          <StoreSettingsSection title="Identidade da Loja" subtitle="Nome, slogan e logotipos">
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Input value={form.store_name} onChange={e => updateField("store_name", e.target.value)} placeholder="WEGX Fast Delivery" className={inputCls} />
              </div>
              <div className="space-y-1.5">
          ...
          <StoreSettingsSection title="Contato e Redes Sociais" subtitle="Informações de contato exibidas no catálogo">
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input value={form.email_contact} onChange={e => updateField("email_contact", e.target.value)} placeholder="contato@wegx.com" className={inputCls} />
              </div>
              <div className="space-y-1.5">
                <Label className="text-[11px] text-[#86868b] font-medium">Instagram</Label>
                <Input value={form.instagram_url} onChange={e => updateField("instagram_url", e.target.value)} placeholder="https://instagram.com/wegx" className={inputCls} />
              </div>
            </div>
            <div className="space-y-1.5">
          ...
          <StoreSettingsSection title="SEO e Rodapé" subtitle="Metadados e texto do rodapé">
            <div className="space-y-4">
              <div className="space-y-1.5">
                ...
                <Input value={form.seo_title} onChange={e => updateField("seo_title", e.target.value)} placeholder="WEGX - Apple Store Delivery" className={inputCls} />
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <Input value={form.footer_text} onChange={e => updateField("footer_text", e.target.value)} placeholder="© 2026 WEGX. Todos os direitos reservados." className={inputCls} />
              </div>
            </div>
          </StoreSettingsSection>
        </div>
